...
classifier = cv2.CascadeClassifier("C:/Users/user/Desktop/facerecognation/facerecognation/haarcascade_frontalface_default.xml")

model = load_model("C:/Users/user/Desktop/facerecognation/facerecognation/final_model.h5")

URL = 'http://192.0.0.4:8080/shot.jpg'

def get_pred_label(pred):
    labels = ['abhipsa', 'shreecttc', 'subhashree']
    return labels[pred]
